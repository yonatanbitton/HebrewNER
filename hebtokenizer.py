...
## Ported to Python 3.7 Michael Elhadad - 11 Jan 2019
##
...
if __name__=='__main__':
  ...
  parser.add_option("-i","--ie",help="input encoding [default %default]",dest="in_enc",default="utf-8")
  parser.add_option("-o","--oe",help="output encoding [default %default]",dest="out_enc",default="utf-8-sig")
  opts, args = parser.parse_args()

  #FILTER = set(['JUNK','ENG'])
  FILTER = set()
  sys.stdout.reconfigure(encoding=opts.out_enc)
  sys.stdin.reconfigure(encoding=opts.in_enc)
